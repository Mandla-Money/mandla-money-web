...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "https://www.xrpl-commons.org/the-aquarium", label: "XRPL Commons Residency", external: true },
      { href: "/faq", label: "FAQ" },
      ...
      <div className="mx-auto max-w-7xl border-t border-white/10 px-6 py-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <p className="text-xs leading-5 text-white/40">
            © {year} Mandla Money (Pty) Ltd · Registration 2019/470624/07 · Authorised
            Financial Services Provider (FSP 55523) · Crypto Asset Service Provider
            (CASP).
          </p>
